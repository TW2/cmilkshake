 ...
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 * Elle sert de sauvegarde des informations du script.</p>
...
public class Infos {
    ...
    public Infos(String resX, String resY){
        ScriptPlayResX = resX;
        ScriptPlayResY = resY;
    }
