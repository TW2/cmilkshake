 ...
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 * Cette classe est un espace de stockage pour un style ASS ou ASS2.</p>
...
public class Style {
     ...
     * @see unlinkAssStyles */
    public static String linkAssStyles(java.util.List<Style> ast){
        String s = "";
        for(Style as : ast){
     ...
     * @see linkAssStyles */
    public static java.util.List<Style> unlinkAssStyles(String s){
        String[] table = s.split(";");
        java.util.List<Style> lst = new java.util.ArrayList<>();
    ...
    public static Style cloneAssStyle(Style org){
    ...
    public Style getClone() throws CloneNotSupportedException{
